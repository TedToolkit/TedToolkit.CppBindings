...
| CGAL-003 | Pack and consume the complete admitted `win-x64` EPICK surface | Owns AC-03 / Owns AC-04 | `CGAL-001`: verified profile manifest, admitted/unsupported inventories, paired sources, and native project metadata / `CGAL-002`: verified Runtime API, exception mapping, result ABI, and cleanup contract | Implemented | `work-items/CGAL-003-pack-and-consume-windows.md` |
