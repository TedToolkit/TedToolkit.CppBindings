...
| --- | --- | --- | --- | --- | --- |
| CGAL-001 | Produce the deterministic finite EPICK Generator and complete profile inventories | Owns AC-01 / Supports AC-03 | None; the parent change already supplies the completed Shared semantic engine and enforced provider topology | Approved | `work-items/CGAL-001-generate-deterministic-epick-profile.md` |
