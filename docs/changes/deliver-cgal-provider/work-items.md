...
| --- | --- | --- | --- | --- | --- |
| CGAL-001 | Produce the deterministic finite EPICK Generator and complete profile inventories | Owns AC-01 / Supports AC-03 | None; the parent change already supplies the completed Shared semantic engine and enforced provider topology | Implemented | `work-items/CGAL-001-generate-deterministic-epick-profile.md` |
| CGAL-002 | Deliver CGAL Runtime failures and finite polymorphic-result semantics with compiled native-boundary proof | Owns AC-02 / Supports AC-04 | None; the parent change already supplies the provider-neutral Shared Runtime and native error boundary | Approved | `work-items/CGAL-002-deliver-runtime-semantics.md` |
