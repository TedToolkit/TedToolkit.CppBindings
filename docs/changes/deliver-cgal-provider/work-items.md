...
| CGAL-002 | Deliver CGAL Runtime failures and finite polymorphic-result semantics with compiled native-boundary proof | Owns AC-02 / Supports AC-04 | None; the parent change already supplies the provider-neutral Shared Runtime and native error boundary | Implemented | `work-items/CGAL-002-deliver-runtime-semantics.md` |
