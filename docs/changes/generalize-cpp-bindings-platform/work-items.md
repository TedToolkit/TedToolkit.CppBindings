...
| CPB-002 | Reusable generation platform with a functioning OCCT provider and renamed solution | Owns AC-02 / Owns AC-05 | CPB-001: verified Runtime public surfaces, lifetime behavior, and direct analyzer-package consumption | In progress | `work-items/CPB-002-generation-platform.md` |
