...
| --- | --- | --- | --- | --- | --- |
| CPB-001 | Consumable generic and OCCT Runtime contracts with standalone diagnostics | Owns AC-03 / Owns AC-04 / Supports AC-02 / Supports AC-05 | None | Implemented | `work-items/CPB-001-runtime-and-diagnostics.md` |
