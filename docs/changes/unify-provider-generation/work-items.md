...
| UPG-004 | Enforce and document the final one-model generation and native-error boundary across all four providers | Owns AC-04 | `UPG-005`, `UPG-001`, `UPG-002`, and `UPG-003`: error unification and all provider migrations verified on the integration baseline | In progress | `work-items/UPG-004-cross-provider-enforcement.md` |
