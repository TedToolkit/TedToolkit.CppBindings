...
| UPG-002 | Migrate Manifold from its private renderer to the verified shared generation contracts | Owns AC-02 / Supports AC-04 | `UPG-001`: verified shared provider, buffer, and composite-result contracts; `UPG-005`: verified common error boundary | In progress | `work-items/UPG-002-manifold-migration.md` |
