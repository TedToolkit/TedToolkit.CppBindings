...
| UPG-003 | Remove remaining non-error generic emission copies from CGAL and OCCT | Owns AC-03 / Supports AC-04 | `UPG-001`: verified shared bootstrap, result, and native-project extension points; `UPG-005`: verified common error boundary | Implemented | `work-items/UPG-003-existing-provider-cleanup.md` |
