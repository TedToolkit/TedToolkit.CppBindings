// -----------------------------------------------------------------------
// <copyright file="NativeArithmeticException.cs" company="TedToolkit">
...
/// <summary>
/// Represents an arithmetic failure reported by a native operation.
/// </summary>
public sealed class NativeArithmeticException : ArithmeticException, INativeException
{
    /// <summary>
    ...
    internal NativeArithmeticException(string message, string? type, string? stack)
        : base(message)
    {
        NativeTypeName = type;
