// -----------------------------------------------------------------------
// <copyright file="NativeNullObjectException.cs" company="TedToolkit">
...
/// <summary>
/// Represents a native null-object failure.
/// </summary>
public sealed class NativeNullObjectException : NativeException
{
    /// <summary>
    ...
    internal NativeNullObjectException(string message, string? type, string? stack)
