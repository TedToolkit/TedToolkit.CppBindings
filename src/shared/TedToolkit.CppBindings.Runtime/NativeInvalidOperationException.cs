// -----------------------------------------------------------------------
// <copyright file="NativeInvalidOperationException.cs" company="TedToolkit">
...
/// <summary>
/// Represents an invalid native operation state.
/// </summary>
public sealed class NativeInvalidOperationException : InvalidOperationException, INativeException
{
    /// <summary>
    ...
    internal NativeInvalidOperationException(string message, string? type, string? stack)
        : base(message)
    {
        NativeTypeName = type;
