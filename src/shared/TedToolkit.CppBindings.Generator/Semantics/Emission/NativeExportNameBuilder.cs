...
/// </summary>
public static class NativeExportNameBuilder
{
    /// <summary>
    ...
    /// <summary>
    /// Gets the intrusive-release export required by an owning smart-pointer result.
    /// </summary>
    /// <param name="elementCppType">The native handle element type.</param>
    /// <returns>The release export name.</returns>
    public static string GetIntrusiveReleaseName(string elementCppType)
    {
    ...
    {
        return method.Type is MethodModelType.INTRUSIVE_RELEASE
               || (method.Type is MethodModelType.DELETE && record.UsesIntrusiveReferenceCounting)
            ? "Release"
