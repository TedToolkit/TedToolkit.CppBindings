// -----------------------------------------------------------------------
// <copyright file="BindingEnumEmitter.cs" company="TedToolkit">
...
public sealed class BindingEnumEmitter(EnumModel enumModel, string cSharpNamespace) : IBindingSourceEmitter
{
    /// <inheritdoc/>
