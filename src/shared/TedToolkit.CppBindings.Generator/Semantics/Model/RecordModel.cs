...
public sealed class RecordModel
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the record participates in intrusive reference ownership.
    /// </summary>
    public required bool UsesIntrusiveReferenceCounting { get; set; }
