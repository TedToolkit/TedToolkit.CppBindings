...
using static TedToolkit.RoslynHelper.Generators.SourceComposer<
    TedToolkit.CppBindings.Occt.SourceGenerators.OcctHeaderTypeGenerator>;

#pragma warning disable RCS0058

namespace TedToolkit.CppBindings.Occt.SourceGenerators;
...
#pragma warning restore RS1035
    ...
    private static SourceFile GenerateHeaderType(DirectoryInfo directory)
    {
        ...
        return File()
            .AddNameSpace(NameSpace("TedToolkit.CppBindings.Occt.Generator")
