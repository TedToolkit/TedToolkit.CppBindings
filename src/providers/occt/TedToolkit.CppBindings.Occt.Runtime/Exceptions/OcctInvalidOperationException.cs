// -----------------------------------------------------------------------
// <copyright file="OcctInvalidOperationException.cs" company="TedToolkit">
...
/// <summary>
/// Represents an invalid operation reported by an executed native OCCT operation.
/// </summary>
public sealed class OcctInvalidOperationException : InvalidOperationException, IOcctException
{
    /// <summary>
