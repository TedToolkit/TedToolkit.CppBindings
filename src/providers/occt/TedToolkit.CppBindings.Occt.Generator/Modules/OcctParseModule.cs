// -----------------------------------------------------------------------
// <copyright file="OcctParseModule.cs" company="TedToolkit">
...
/// </summary>
public sealed class OcctParseModule : Module<bool>
{
    private const string RELAY_FILE_NAME = "main.cpp";

    private readonly IRecordModelManager _recordModelManager;

    private readonly IOptions<OcctGenerationOptions> _generationOptions;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="OcctParseModule"/> class.
    /// </summary>
