// -----------------------------------------------------------------------
// <copyright file="CgalOutOfMemoryException.cs" company="TedToolkit">
...
/// </summary>
public sealed class CgalOutOfMemoryException : CgalException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CgalOutOfMemoryException"/> class.
    /// </summary>
    ...
    internal CgalOutOfMemoryException(
        string message,
