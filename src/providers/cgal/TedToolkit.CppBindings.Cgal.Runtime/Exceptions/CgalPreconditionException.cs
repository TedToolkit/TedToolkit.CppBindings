// -----------------------------------------------------------------------
// <copyright file="CgalPreconditionException.cs" company="TedToolkit">
...
/// <summary>
/// Represents a native <c>CGAL::Precondition_exception</c>.
/// </summary>
public sealed class CgalPreconditionException : CgalFailureException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CgalPreconditionException"/> class.
    /// </summary>
    ...
    internal CgalPreconditionException(
        string message,
