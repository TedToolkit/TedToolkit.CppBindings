// -----------------------------------------------------------------------
// <copyright file="CgalStandardException.cs" company="TedToolkit">
...
/// <summary>
/// Represents another native <c>std::exception</c>.
/// </summary>
public sealed class CgalStandardException : CgalException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CgalStandardException"/> class.
    /// </summary>
    ...
    internal CgalStandardException(
        string message,
