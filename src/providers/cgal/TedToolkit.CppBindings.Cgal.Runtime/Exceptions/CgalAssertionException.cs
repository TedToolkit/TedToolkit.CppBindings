// -----------------------------------------------------------------------
// <copyright file="CgalAssertionException.cs" company="TedToolkit">
...
/// <summary>
/// Represents a native <c>CGAL::Assertion_exception</c>.
/// </summary>
public sealed class CgalAssertionException : CgalFailureException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CgalAssertionException"/> class.
    /// </summary>
    ...
    internal CgalAssertionException(
        string message,
