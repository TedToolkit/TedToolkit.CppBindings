// -----------------------------------------------------------------------
// <copyright file="CgalTestException.cs" company="TedToolkit">
...
/// <summary>
/// Represents a native <c>CGAL::Test_exception</c>.
/// </summary>
public sealed class CgalTestException : CgalFailureException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CgalTestException"/> class.
    /// </summary>
