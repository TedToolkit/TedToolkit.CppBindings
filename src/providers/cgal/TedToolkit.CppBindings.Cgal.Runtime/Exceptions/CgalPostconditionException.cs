// -----------------------------------------------------------------------
// <copyright file="CgalPostconditionException.cs" company="TedToolkit">
...
/// <summary>
/// Represents a native <c>CGAL::Postcondition_exception</c>.
/// </summary>
public sealed class CgalPostconditionException : CgalFailureException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CgalPostconditionException"/> class.
    /// </summary>
    ...
    internal CgalPostconditionException(
        string message,
