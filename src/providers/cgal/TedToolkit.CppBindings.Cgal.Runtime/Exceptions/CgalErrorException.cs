// -----------------------------------------------------------------------
// <copyright file="CgalErrorException.cs" company="TedToolkit">
...
/// <summary>
/// Represents a native <c>CGAL::Error_exception</c>.
/// </summary>
public sealed class CgalErrorException : CgalFailureException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CgalErrorException"/> class.
    /// </summary>
