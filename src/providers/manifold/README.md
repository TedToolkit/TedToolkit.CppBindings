...
The Manifold provider owns the finite `manifold-3.5.2-windows-v1` profile, its diagnostic Runtime,
...
| `TedToolkit.CppBindings.Manifold.Generator.Tool` | Materialize the profile during repository builds without entering the consumer graph |
...
other geometry providers nor supplies collection or geometry conversion APIs.
