// -----------------------------------------------------------------------
// <copyright file="OcctArgumentOutOfRangeException.cs" company="TedToolkit">
...
/// <summary>
/// Represents an out-of-range argument reported by an executed native OCCT operation.
/// </summary>
public sealed class OcctArgumentOutOfRangeException : ArgumentOutOfRangeException, IOcctException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OcctArgumentOutOfRangeException"/> class from copied native diagnostics.
    /// </summary>
    ...
    internal OcctArgumentOutOfRangeException(
