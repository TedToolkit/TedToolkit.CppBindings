// -----------------------------------------------------------------------
// <copyright file="OcctOutOfMemoryException.cs" company="TedToolkit">
...
/// <summary>
/// Represents an allocation failure reported by an executed native OCCT operation.
/// </summary>
public sealed class OcctOutOfMemoryException : OutOfMemoryException, IOcctException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OcctOutOfMemoryException"/> class from copied native diagnostics.
    /// </summary>
    ...
    internal OcctOutOfMemoryException(
