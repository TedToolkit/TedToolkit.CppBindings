// -----------------------------------------------------------------------
// <copyright file="OcctOverflowException.cs" company="TedToolkit">
...
/// <summary>
/// Represents an overflow reported by an executed native OCCT operation.
/// </summary>
public sealed class OcctOverflowException : OverflowException, IOcctException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OcctOverflowException"/> class from copied native diagnostics.
    /// </summary>
    ...
    internal OcctOverflowException(
        string message,
