// -----------------------------------------------------------------------
// <copyright file="OcctUnknownException.cs" company="TedToolkit">
...
/// <summary>
/// Represents an unknown native failure reported by an OCCT operation.
/// </summary>
public sealed class OcctUnknownException : OcctException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="OcctUnknownException"/> class from copied native diagnostics.
    /// </summary>
