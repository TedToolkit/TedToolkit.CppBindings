...
interfaces, C# and C++ generation, export inventories or build descriptions, and their tests. The complete
...
- [Generator pipeline](../../README.md#preparation-and-output-boundary)
