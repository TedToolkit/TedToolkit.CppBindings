...
using static TedToolkit.RoslynHelper.Generators.SourceComposer<
    TedToolkit.CppBindings.Occt.Generator.Generators.EnumGenerator>;
...
/// <param name="cSharpNamespace">The shared generated namespace.</param>
internal sealed class EnumGenerator(EnumModel enumModel, string cSharpNamespace = "TedToolkit.CppBindings.Occt") : IGenerator
{
    /// <inheritdoc/>
