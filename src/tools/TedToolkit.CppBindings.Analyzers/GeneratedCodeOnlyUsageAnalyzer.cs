...
{
    private const string MarkerMetadataName = "TedToolkit.CppBindings.GeneratedCodeOnlyAttribute";

    /// <summary>
    /// Identifies use of an API reserved for generated C++ binding code.
    /// </summary>
    public const string DiagnosticId = "TTCB001";

    private static readonly DiagnosticDescriptor Rule = new(
        DiagnosticId,
        "Runtime API is reserved for generated binding code",
        "API '{0}' is reserved for generated C++ binding code; use a generated factory or operation",
        "Usage",
        DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "Handwritten code must not use public Runtime implementation hooks reserved for generated C++ bindings.");
