...
using TedToolkit.CppBindings.Runtime.FirstWrapper;
using TedToolkit.CppBindings.Runtime.SecondWrapper;
...
internal sealed class WrapperIntegrationTests
{
    ...
    public async Task Should_give_the_windows_named_wrapper_no_additional_capability_Async()
    {
        ...
        await Assert.That(windowsAssembly.GetName().Name).IsEqualTo("TedToolkit.CppBindings.Occt.Windows");
